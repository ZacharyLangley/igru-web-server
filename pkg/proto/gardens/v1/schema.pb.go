...
var file_gardens_v1_schema_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_gardens_v1_schema_proto_depIdxs = []int32{
	2, // 0: gardens.v1.Garden.created_at:type_name -> google.protobuf.Timestamp
	2, // 1: gardens.v1.Garden.updated_at:type_name -> google.protobuf.Timestamp
	2, // 2: gardens.v1.Plant.acquired_at:type_name -> google.protobuf.Timestamp
	2, // 3: gardens.v1.Plant.created_at:type_name -> google.protobuf.Timestamp
	2, // 4: gardens.v1.Plant.updated_at:type_name -> google.protobuf.Timestamp
