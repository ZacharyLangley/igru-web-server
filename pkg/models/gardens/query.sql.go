...
RETURNING id, name, comment, ingredients, instructions, ph, mix_time, tags, created_at, updated_at
`
...
SELECT id, name, comment, ingredients, instructions, ph, mix_time, tags, created_at, updated_at FROM recipes
WHERE id = $1 LIMIT 1
`
