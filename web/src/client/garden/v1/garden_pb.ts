...
import { Garden } from "./schema_pb";

/**
 * @generated from message garden.v1.CreateGardenRequest
 */
export class CreateGardenRequest extends Message<CreateGardenRequest> {
  ...
  static readonly typeName = "garden.v1.CreateGardenRequest";
...
/**
 * @generated from message garden.v1.CreateGardenResponse
 */
export class CreateGardenResponse extends Message<CreateGardenResponse> {
  /**
   * @generated from field: garden.v1.Garden garden = 1;
   */
  garden?: Garden;
  ...
  static readonly runtime = proto3;
  static readonly typeName = "garden.v1.CreateGardenResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message garden.v1.DeleteGardenRequest
 */
...
/**
 * @generated from message garden.v1.DeleteGardenResponse
 */
export class DeleteGardenResponse extends Message<DeleteGardenResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "garden.v1.DeleteGardenResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "garden", kind: "message", T: Garden },
  ]);
...
/**
 * @generated from message garden.v1.UpdateGardenRequest
 */
...
/**
 * @generated from message garden.v1.UpdateGardenResponse
 */
export class UpdateGardenResponse extends Message<UpdateGardenResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "garden.v1.UpdateGardenResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "garden", kind: "message", T: Garden },
  ]);
...
/**
 * @generated from message garden.v1.GetGardensRequest
 */
export class GetGardensRequest extends Message<GetGardensRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "garden.v1.GetGardensRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message garden.v1.GetGardensResponse
 */
export class GetGardensResponse extends Message<GetGardensResponse> {
  /**
   * @generated from field: repeated garden.v1.Garden gardens = 1;
   */
  gardens: Garden[] = [];
  ...
  static readonly runtime = proto3;
  static readonly typeName = "garden.v1.GetGardensResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message garden.v1.GetGardenRequest
 */
...
/**
 * @generated from message garden.v1.GetGardenResponse
 */
export class GetGardenResponse extends Message<GetGardenResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "garden.v1.GetGardenResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "garden", kind: "message", T: Garden },
  ]);
