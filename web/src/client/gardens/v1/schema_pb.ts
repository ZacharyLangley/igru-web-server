...
// @generated from file gardens/v1/schema.proto (package gardens.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message gardens.v1.Garden
 */
export class Garden extends Message<Garden> {
  ...
  static readonly typeName = "gardens.v1.Garden";
...
/**
 * @generated from message gardens.v1.Plant
 */
export class Plant extends Message<Plant> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "gardens.v1.Plant";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "group_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message gardens.v1.Strain
 */
export class Strain extends Message<Strain> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "gardens.v1.Strain";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "group_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message gardens.v1.Recipe
 */
export class Recipe extends Message<Recipe> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "gardens.v1.Recipe";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
